...
public class ChessBoard extends JPanel implements Serializable
{
	...
	public ChessBoard(BoardState boardState, GUI listener, Dimension size)
	{
		...
		green = new Color(51, 153, 102);
		cream = new Color(255, 255, 204);
	...
	{
		squares[loc.getRow()][loc.getCol()].setBackground(new Color(0, 179, 179));
	}
	
	public void selected(Location loc)
	{
		getAtLocation(new Location(loc.getRow(),loc.getCol())).setBorder(BorderFactory.createLineBorder(new Color(0, 255, 204), 4));
	}
